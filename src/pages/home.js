...
const getHome = () => {
  ...
  const when = getSection("When", "At the Rozehouse we've recognized the impact that eating animals and animal products has not only on our bodies, but also the earth. By eating animal-protein based diets we poison ourselves and the planet severely, leading to terminal conditions such as cancer and climate change. The time to make a change is now, and we are here to help!");
